...
| 水印添加   | 文字水印 / 图片水印，支持位置、透明度、旋转、平铺模式                                               |
| 旋转翻转   | 任意角度旋转、水平/垂直翻转，一键批量应用                                                           |
| 基础调色   | 亮度、对比度、饱和度、色相、模糊、灰度、反色 7 项调整                                               |
| 拼图合并   | 横向/纵向拼接多张图片，支持间距、背景色与对齐方式                                                   |
| 图片元数据 | 查看尺寸、体积、修改时间，导出时自动清理敏感元数据                                                  |
